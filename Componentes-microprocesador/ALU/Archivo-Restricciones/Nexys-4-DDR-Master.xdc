...
# Banderas de la ALU C, Z, N, OV
set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports { CARRY }]; #IO_L18N_T2_A11_D27_14 Sch=led[5]
set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports {   Z   }]; #IO_L17P_T2_A14_D30_14 Sch=led[6]
set_property -dict { PACKAGE_PIN U16   IOSTANDARD LVCMOS33 } [get_ports {  NEG  }]; #IO_L18P_T2_A12_D28_14 Sch=led[7]
...
##Conector LAB REMOTO
##Si se utiliza este conector no se debe utilizar el Pmod Header JA y el Pmod Header JB
...
#set_property -dict { PACKAGE_PIN D17   IOSTANDARD LVCMOS33 } [get_ports { LAB[14] }]; #IO_L16N_T2_A27_15 Sch=ja[7]
